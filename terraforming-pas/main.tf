...
module "pas" {
  ...
  internetless       = "${var.internetless}"
  create_elb_nlb     = "${var.create_elb_nlb}"
  create_elb_alb     = "${var.create_elb_alb}"
  https_web_key      = "${var.https_web_key}"
  https_web_cert     = "${var.https_web_cert}"
  https_web_chain    = "${var.https_web_chain}"
  bucket_suffix      = "${local.bucket_suffix}"
  zone_id            = "${module.infra.zone_id}"
  dns_suffix         = "${var.dns_suffix}"
  use_route53        = "${var.use_route53}"
